...
class Server{
    constructor(){
        ...
        this.userPath = '/gestorOpinionApi/v1/users';
        this.authPath = '/gestorOpinionApi/v1/auth';
        this.postsPath = '/gestorOpinionApi/v1/posts';
        this.commentsPath = '/gestorOpinionApi/v1/comments';
